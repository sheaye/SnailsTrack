...
import com.snail.track.samples.path.basic.BasicPathActivity;
import com.snail.track.samples.path.basic.BasicPathTestView;
import com.snail.track.samples.path.bezier.BezierActivity;
import com.snail.track.samples.path.bool.PathBoolActivity;
import com.snail.track.samples.path.fill.FillPathActivity;
